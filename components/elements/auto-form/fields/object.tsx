import { DEFAULT_ZOD_HANDLERS, INPUT_COMPONENTS } from '@/components/elements/auto-form/config'
import { AutoFormArray } from '@/components/elements/auto-form/fields/array'
import type { FieldConfig, FieldConfigItem } from '@/components/elements/auto-form/types'
import {
  beautifyObjectName,
  getBaseSchema,
  getBaseType,
  zodToHtmlInputProps,
} from '@/components/elements/auto-form/utils'
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/elements/shadcn-ui/accordion'
import { FormField } from '@/components/elements/shadcn-ui/form'
