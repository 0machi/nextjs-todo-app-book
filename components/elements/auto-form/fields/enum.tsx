...
import { getBaseSchema } from '@/components/elements/auto-form/utils'
import { FormControl, FormDescription, FormItem, FormLabel, FormMessage } from '@/components/elements/shadcn-ui/form'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/elements/shadcn-ui/select'
import * as z from 'zod'

export const AutoFormEnum = ({ label, isRequired, field, fieldConfigItem, zodItem }: AutoFormInputComponentProps) => {
